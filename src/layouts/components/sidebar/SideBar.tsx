  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label='Sidebar'
      >
        <div className='h-full px-8 py-5 overflow-y-auto bg-white '>
          <div className='flex items-center justify-start '>
            <Image src='/logo.svg' alt='' width={160} height={60}></Image>
          </div>
          <ul className='mt-6 space-y-2 font-medium'>
            <li>
              <a href='#' className='flex items-center text-gray-900 rounded-lg hover:bg-gray-100'>
                <svg
                  aria-hidden='true'
                  className='w-6 h-6 text-gray-500 transition duration-75 d '
                  fill='currentColor'
                  viewBox='0 0 20 20'
                  xmlns='http://www.w3.org/2000/svg'
                >
